...
namespace SpiceEngineCore.Geometry
{
    ...
    public static class MathHelper
    {
        ...
        public static float NextPowerOfTwo(float n)
        {
            ...
            return (float)Math.Pow(2, (float)Math.Ceiling((float)Math.Log(n, 2)));
        }
        ...
        public static bool ApproximatelyEqual(float a, float b, int maxDeltaBits)
        {
            ...
            long k = (long)a;// BitConverter.SingleToInt32Bits(a);
            if (k < 0)
            {
                k = int.MinValue - k;
            }

            long l = (long)b;// BitConverter.SingleToInt32Bits(b);
            if (l < 0)
            {
                l = int.MinValue - l;
            }
