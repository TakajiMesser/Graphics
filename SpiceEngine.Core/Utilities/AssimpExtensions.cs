...
namespace SpiceEngine.Core.Utilities
{
    public static class AssimpExtensions
    {
        ...
        public static SpiceEngineCore.Geometry.Quaternion ToQuaternion(this Assimp.Quaternion quaternion) => new SpiceEngineCore.Geometry.Quaternion(quaternion.X, quaternion.Y, quaternion.Z, quaternion.W);
