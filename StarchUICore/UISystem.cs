...
namespace StarchUICore
{
    ...
    public class UISystem : ComponentSystem<IElement, IElementBuilder>, IUIProvider
    {
        ...
        public void RegisterSelection(int entityID)
        {
        ...
        public void RegisterDeselection(int entityID)
        {
        ...
        public override void LoadBuilderSync(int entityID, IElementBuilder builder)
        {
        ...
        protected override void LoadComponents()
        {
            ...
            foreach (var component in _components)
            {
                ...
                component.MeasurementChanged += (s, args) =>
                {
                ...
                component.HorizontalAnchor = component.HorizontalAnchor.Attached(GetElementByName(horizontalAnchorName));

                var verticalAnchorName = _verticalAnchorNamesByID[component.EntityID];
                component.VerticalAnchor = component.VerticalAnchor.Attached(GetElementByName(verticalAnchorName));

                var horizontalDockName = _horizontalDockNamesByID[component.EntityID];
                component.HorizontalDock = component.HorizontalDock.Attached(GetElementByName(horizontalDockName));

                var verticalDockName = _verticalDockNamesByID[component.EntityID];
                component.VerticalDock = component.VerticalDock.Attached(GetElementByName(verticalDockName));
            }
