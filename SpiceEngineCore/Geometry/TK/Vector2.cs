...
namespace SpiceEngineCore.Geometry
{
    ...
    public struct TVector2 : IEquatable<TVector2>
    {
        ...
        [Pure]
        public static TVector2 TransformRow(TVector2 vec, Matrix2 mat)
        {
        ...
        public static void TransformRow(in TVector2 vec, in Matrix2 mat, out TVector2 result)
        {
            result = new TVector2(
                (vec.X * mat.M00) + (vec.Y * mat.M10),
                (vec.X * mat.M01) + (vec.Y * mat.M11));
        }
        ...
        [Pure]
        public static TVector2 Transform(TVector2 vec, Quaternion quat)
        {
        ...
        public static void Transform(in TVector2 vec, in Quaternion quat, out TVector2 result)
        {
        ...
        /// <returns>The transformed vector.</returns>
        [Pure]
        public static TVector2 TransformColumn(Matrix2 mat, TVector2 vec)
        {
        ...
        /// <param name="vec">The vector to transform.</param>
        /// <param name="result">The transformed vector.</param>
        public static void TransformColumn(in Matrix2 mat, in TVector2 vec, out TVector2 result)
        {
        ...
        /// <returns>The transformed vector.</returns>
        [Pure]
        public static TVector2 operator *(TVector2 vec, Matrix2 mat)
        {
            TransformRow(in vec, in mat, out TVector2 result);
            return result;
        }
        ...
        /// <returns>The transformed vector.</returns>
        [Pure]
        public static TVector2 operator *(Matrix2 mat, TVector2 vec)
        {
            TransformColumn(in mat, in vec, out TVector2 result);
            return result;
        }
        ...
        [Pure]
        public static TVector2 operator *(Quaternion quat, TVector2 vec)
        {
            Transform(in vec, in quat, out TVector2 result);
            return result;
        }
