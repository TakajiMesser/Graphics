...
namespace SpiceEngineCore.Geometry
{
    ...
    public struct TColor4 : IEquatable<TColor4>
    {
        ...
        /// <summary>
        /// Returns this TColor4 as a Vector4. The resulting struct will have XYZW mapped to RGBA, in that order.
        /// </summary>
        /// <param name="c">The TColor4 to convert.</param>
        /// <returns>The TColor4, converted into a Vector4.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [Pure]
        public static explicit operator Vector4(TColor4 c)
        {
            return new Vector4(c.R, c.G, c.B, c.A);// Unsafe.As<TColor4, Vector4>(ref c);
        }
        ...
        /// </param>
        [Pure]
        public static TColor4 FromHsl(Vector4 hsl)
        {
        ...
        /// <param name="rgb">Color value to convert.</param>
        [Pure]
        public static Vector4 ToHsl(TColor4 rgb)
        {
        ...
        /// </param>
        [Pure]
        public static TColor4 FromHsv(Vector4 hsv)
        {
        ...
        /// <param name="rgb">Color value to convert.</param>
        [Pure]
        public static Vector4 ToHsv(TColor4 rgb)
        {
            var max = Math.Max(rgb.R, Math.Max(rgb.G, rgb.B));
            var min = Math.Min(rgb.R, Math.Min(rgb.G, rgb.B));
            var diff = max - min;
        ...
        [Pure]
        public static TColor4 FromXyz(Vector4 xyz)
        {
        ...
        /// <remarks>Uses the CIE XYZ colorspace.</remarks>
        [Pure]
        public static Vector4 ToXyz(TColor4 rgb)
        {
        ...
        [Pure]
        public static TColor4 FromYcbcr(Vector4 ycbcr)
        {
        ...
        /// <remarks>Converts using ITU-R BT.601/CCIR 601 W(r) = 0.299 W(b) = 0.114 U(max) = 0.436 V(max) = 0.615.</remarks>
        [Pure]
        public static Vector4 ToYcbcr(TColor4 rgb)
        {
        ...
        /// </param>
        [Pure]
        public static TColor4 FromHcy(Vector4 hcy)
        {
        ...
        /// <param name="rgb">Color value to convert.</param>
        [Pure]
        public static Vector4 ToHcy(TColor4 rgb)
        {
            var max = Math.Max(rgb.R, Math.Max(rgb.G, rgb.B));
            var min = Math.Min(rgb.R, Math.Min(rgb.G, rgb.B));
            var diff = max - min;
