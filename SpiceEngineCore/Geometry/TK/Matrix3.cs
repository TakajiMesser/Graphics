...
namespace SpiceEngineCore.Geometry
{
    ...
    public struct TMatrix3 : IEquatable<TMatrix3>
    {
        ...
        public TMatrix3(Matrix4 matrix)
        {
            Row0 = new TVector3(matrix.Row0.Xyz.X, matrix.Row0.Xyz.Y, matrix.Row0.Xyz.Z);
            Row1 = new TVector3(matrix.Row1.Xyz.X, matrix.Row1.Xyz.Y, matrix.Row1.Xyz.Z);
            Row2 = new TVector3(matrix.Row2.Xyz.X, matrix.Row1.Xyz.Y, matrix.Row1.Xyz.Z);
        }
        ...
        public static void CreateFromQuaternion(in Quaternion q, out TMatrix3 result)
        {
        ...
        /// <returns>A matrix instance.</returns>
        [Pure]
        public static TMatrix3 CreateFromQuaternion(Quaternion q)
        {
