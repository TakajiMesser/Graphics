...
namespace SpiceEngine.Outputs
{
    public class Audio
    {
        ...
        /*public void Play(Vector3 l_position, Vector3 l_dir, Vector3 l_up)
        {
            int state;
            ...
            {
                throw new AudioException("Could not buffer sound from file " + FileName + ": " + AL.GetError());
            }
